        ...
        if len(series_1) > 0 and len(series_1) == len(series_2):
            ...
            if abs(z_score) > ZSCORE_THRESH:
                ...
                if not is_base_open and not is_quote_open:
                    ...
                    # Get price and string format (acceptable price and string format with correct number of decimals)
                    ...
                    # Ensure size is inside the DYDX requirements
